...
const motores = [
  { nombre: '5.2 FSI V10', sonido: require('../../assets/audio/motores_sonidos/audi.mp3') },
  { nombre: 'M TwinPower Turbo V8', sonido: require('../../assets/audio/motores_sonidos/bmw.mp3') },
  { nombre: 'HEMI 5.7 SUPERCARGADO', sonido: require('../../assets/audio/motores_sonidos/dodge.mp3') },
  { nombre: 'Ferrari F120A', sonido: require('../../assets/audio/motores_sonidos/ferrari.mp3') },
  { nombre: 'Wankel 13B', sonido: require('../../assets/audio/motores_sonidos/mazda.mp3') },
  { nombre: 'M178 V8 Biturbo 4.0', sonido: require('../../assets/audio/motores_sonidos/mercedes.mp3') },
  { nombre: 'Coyote 5.0L Ti-VCT V8', sonido: require('../../assets/audio/motores_sonidos/mustang.mp3') },
  { nombre: 'RB26DETT 2.6 Turbo', sonido: require('../../assets/audio/motores_sonidos/nissan.mp3') },
];
...
function AutoDesigner() {
  ...
  const handleChassisSelect = (index) => {
    setSelectedChassis(chassisNames[index]);
  };
    ...
    <div>
        ...
        <div className="option" id="motor" onMouseEnter={() => handlePartSelect('engine')}>
          ...
          <div className="grid-container">
            {motores.map((motor, index) => (
              <button
                key={index}
                className={`grid-box ${selectedEngine?.nombre === motor.nombre ? 'selected' : ''}`}
      ...
      <div>
        ...
        {selectedPart === 'engine' && selectedEngine !== null && (
          <p>Selected engine: {selectedEngine.nombre}</p>
        )}
      </div>
